...
For regular web page paragraphs, it is useful to know the topic of the page (\eg from its title) and the context (such as text that immediately precedes the paragraph in the document).
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.48\textwidth]{img/score_hist}
